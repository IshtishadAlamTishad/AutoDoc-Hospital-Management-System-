...
namespace AutoDoc
{
    public partial class DoctorMsgForm : Form
    {
        public DoctorMsgForm()
        {
            InitializeComponent();
        }
        ...
        private void showMsgBox_TextChanged(object sender, EventArgs e)
        {
        ...
        private void DoctorMsgForm_Load(object sender, EventArgs e)
        {
            getID();
            fillCombo();
            getRecords();
        ...
        private void deleteMsgBtn_Click_1(object sender, EventArgs e)
        {
            if (chatSerial > 0)
            {
